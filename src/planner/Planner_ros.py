...
class Planner():
    ...
    def init(self):
        ...
        help(self.track)
        # print("raceline_len_m : " , self.track.raceline_len_m)
        # print("raceline_s : " , self.track.raceline_s, "len : ", len(self.track.raceline_s))
        # print("elem 0 : ", len(self.track.raceline_s[0]))
        # print("elem 1 : ", len(self.track.raceline_s[1]))
        # print("elem 2 : ", self.track.raceline_s[2])

        # for i in range(len(self.track.raceline_s[0])):
        #      print(i, ", ",  self.track.raceline_s[0][i])
    ...
    def plan(self):
        ...
        vs = 1.3 #NOTE : current velocity
        #x0 = [0,0,vs]
        coord = self.car.states[0:2] #NOTE : probably vehicle state x,y,theta
        car_state_curvi = self.cartesianToCurvilinear(coord,skip_wrap=True) #NOTE : find a closest point in s domain. argmin dist
        x0 = [car_state_curvi[0], car_state_curvi[1], vs] #NOTE : x0 : [s domain s, t, vs]
